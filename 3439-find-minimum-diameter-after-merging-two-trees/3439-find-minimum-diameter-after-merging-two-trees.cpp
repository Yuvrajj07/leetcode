...
//         int d1=calc_dia(n,adj1);
//         int d2=calc_dia(m,adj2);
//         int comb_dia=ceil(d1/2.0)+ceil(d2/2.0)+1;

//         return max({d1,d2,comb_dia});
        
//     }
//     private:
//     vector<vector<int>>create_adj(int size,vector<vector<int>>&edges){
...
//         return adj;
//     }
//     int calc_dia(int n, vector<vector<int>>& adjList) {
//         auto [farthestNode, _] = findFarthestNode(n, adjList, 0);
//         auto [_, diameter] = findFarthestNode(n, adjList, farthestNode);
//         return diameter;
//     }
